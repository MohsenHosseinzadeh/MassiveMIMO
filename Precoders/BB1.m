...
% -------------------------------------------------------------------------
    ...
    % tricks (true/false)
    sorted_decomp = false; % sorted QR decomposition
    initial_radius = false; % initial radius using WF solution
    prune_symmetry = false; % prune 1/2 of the tree by symmetry
    predict_future = false; % tighten bound on numerator
